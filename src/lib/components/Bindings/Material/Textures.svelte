...
{#if
  ...
  {#if object.specularMap}
    <Image bind:value={object.specularMap.image.src} fit="cover" label="specularMap" />
  {/if}
{/if}

{#if object instanceof THREE.MeshMatcapMaterial}
  {#if object.matcap}
    <Image bind:value={object.matcap.image.src} fit="cover" label="matcap" />
  {/if}
{/if}
...
{#if
  ...
  object instanceof THREE.MeshMatcapMaterial ||
  object instanceof THREE.MeshToonMaterial
}
  {#if object.map}
...
{#if
  ...
  {#if object.normalMap}
    <Image bind:value={object.normalMap.image.src} fit="cover" label="normalMap" />
    <Binding bind:object key='normalMapType' label='normalMapType' />
    <Point bind:value={object.normalScale} />
  {/if}
{/if}

{#if 'envMap' in object && object.envMap instanceof THREE.Texture}
  <Image bind:value={object.envMap.image.src} fit="cover" label="envMap" />
{/if}
...
{#if object instanceof THREE.MeshToonMaterial}
  {#if object.gradientMap}
    <Image bind:value={object.gradientMap.image.src} fit="cover" label="gradientMap" />
  {/if}
{/if}
